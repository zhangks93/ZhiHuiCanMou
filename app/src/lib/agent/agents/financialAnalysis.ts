...
// Specialized agent for education logistics business data analysis
...
const FINANCIAL_ANALYSIS_SYSTEM_PROMPT = `你是教育后勤集团的智能经营分析助手，专注于25学年经营数据的查询与分析。
...
export const financialAnalysisAgent: AgentDefinition = {
  id: 'financial-analysis',
  name: '财务分析助手',
  description: '专注于25学年经营数据分析',
  tagline: '查看经营异常、生成分析报告、对比部门表现',
  icon: {
    type: 'emoji',
    value: '🤖',
  },
