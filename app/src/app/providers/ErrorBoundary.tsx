      ...
      return (
        <div className="flex min-h-screen items-center justify-center bg-base-200 p-8">
          <div className="max-w-md rounded-lg bg-base-100 p-6 shadow-xl">
            <h2 className="mb-2 text-title font-semibold text-error">应用加载失败</h2>
            <p className="mb-4 text-body text-body-content/80">{this.state.error.message}</p>
            <p className="text-caption text-body-content/60">
