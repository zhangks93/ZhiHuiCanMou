...
import {
  ...
  BizUnitCornerHeaderCell,
  METRIC_GROUP_WIDTH,
  MetricDragHeadersRow,
  MOBILE_BREAKPOINT,
} from './TableViewColumns'
import {
  getNodeThresholds,
...
import { MetricTripleValueCells } from './ThresholdCell'
          ...
          <div className="biz-data-table__header-row">
            <div className="biz-data-table__fixed-column">
              ...
              >
                <thead>
                  <tr>
                    <BizUnitCornerHeaderCell businessUnitColumnWidth={businessUnitColumnWidth} />
                  </tr>
                </thead>
              </table>
            </div>
                ...
                >
                  <thead>
                    <tr>
                      ...
                      >
                        <MetricDragHeadersRow metricOrder={metricOrder} metricGroupWidth={metricGroupWidth} />
                      </SortableContext>
                    </tr>
                  </thead>
                </table>
