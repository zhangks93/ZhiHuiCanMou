  ...
  return (
    <div className="relative inline-flex items-center">
      ...
      <select
        ...
        className="appearance-none h-8 pl-8 pr-7 rounded-full text-xs font-medium bg-[rgba(15,23,42,0.06)] border-0 text-[var(--color-text-strong)] cursor-pointer hover:bg-[rgba(15,23,42,0.1)] transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--color-accent)]/20"
      >
        {options.map(month => (
